...
export const getOpenedSidebar = createSelector(getLayoutState, (state: LayoutState) => state.openedSidebar);

export const getShowedSubmenu = createSelector(getLayoutState, (state: LayoutState) => state.menu.showedSubmenu);

export const getBreadcrumbs = createSelector(getLayoutState, (state: LayoutState) => state.breadcrumbs);
